...
<p className="head">ECAST (Electronics and Computer Community Amidst Students)</p> is a vibrant and dynamic student club at Thapathali Engineering Campus, Kathmandu.. ECAST was established in 2016 A.D., and is a non-political student-led community.<br></br><br></br> As a non-political student union, ECAST serves as the representative body for Electronics and Computer engineering students, dedicated to their holistic development and success.<br></br><br></br>
...
At ECAST, we believe in fostering a community where students can learn, grow, and excel together. Our initiatives are designed to bridge the gap between theoretical knowledge and practical application, ensuring that our members are well-prepared for the challenges of the modern engineering landscape.<br></br><br></br>
