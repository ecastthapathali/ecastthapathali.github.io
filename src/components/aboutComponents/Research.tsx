const Research = () => {
  return (
    <>
      ...
      <div className="highlight text-white flex justify-between w-full h-auto pb-12 bg-black flex-col sm:flex-row sm:justify-center">
        ...
        <br />
         This  research was led by Nishan Khanal. The R&D Unit initiated the work of research in our community. The first notable work of this unit includes a collaboration with Racheal Lau regarding a talk on research.<br /><br />
  ...
  <button
    className="btn text-white no-underline p-2 font-semibold cursor-pointer rounded border-2 border-black outline-none transition-all hover:bg-red-600 hover:border-transparent mx-2 relative overflow-hidden"
    onClick={() => {
      window.location.href = 'https://ecast.tcioe.edu.np/assets/research/ProposalDeepGenerativeModelingforAutomatedImageManipulationbyInterpretingText-GuidedPromptswithNaturalLanguageInstructions.pdf'; // Replace '#' with the actual link for demonstration
    }}
  >
    <span className="absolute top-0 left-0 w-full h-full bg-red-600 mix-blend-overlay animate-neon"></span>
    Demonstration
