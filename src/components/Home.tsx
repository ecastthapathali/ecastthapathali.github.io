...
const Home = () => {
	...
	<main className="flex h-screen w-full">
		{/* Home Hero Section */}
		<img src={Background} className="absolute top-0 left-0 brightness-15 h-screen w-full bg-cover"/>
		<div className="fixed top-20 p-8 text-white flex flex-col w-[100%] h-[100%] justify-evenly items-center">
			<h1 className="text-6xl sm:text-8xl lg:text-9xl animate-texColCha font-extralight tracking-wideext">ECAST</h1>
